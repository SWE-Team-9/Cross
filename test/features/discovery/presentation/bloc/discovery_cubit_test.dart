...
void main() {
  ...
  group('DiscoveryCubit', () {
    ...
    blocTest<DiscoveryCubit, DiscoveryState>(
      ...
      act: (cubit) => cubit.resolve('$baseUrl/ali/track-slug'),
      expect: () => [
    ...
    blocTest<DiscoveryCubit, DiscoveryState>(
      ...
      act: (cubit) => cubit.resolve('  $baseUrl/ali/playlist  '),
      verify: (_) {
        expect(
          repository.calls,
          ['$baseUrl/ali/playlist'],
        );
      },
    );
    ...
    blocTest<DiscoveryCubit, DiscoveryState>(
      ...
      act: (cubit) => cubit.resolve('$baseUrl/bad-link'),
      expect: () => [
        const DiscoveryLoading(),
