...
void main() {
  group('SocketMessageEventDto', () {
    ...
    test('fromJson parses NEW_MESSAGE event', () {
      final dto = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'NEW_MESSAGE',
    ...
    test('fromJson parses deleted message aliases', () {
      final deleted = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'MESSAGE_DELETED',
        'messageId': 'message-1',
      });

      final deleteAlias = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'DELETE_MESSAGE',
    ...
    test('fromJson parses conversation read aliases', () {
      final read = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'CONVERSATION_READ',
      });

      final markRead = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'MARK_READ',
      });
    ...
    test('fromJson parses conversation updated aliases', () {
      final updated = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'CONVERSATION_UPDATED',
      });

      final archived = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'CONVERSATION_ARCHIVED',
      });

      final unarchived = SocketMessageEventDto.fromJson(<String, dynamic>{
    ...
    test('fromJson parses unread, blocked, and unblocked events', () {
      final unread = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'UNREAD_COUNT_UPDATED',
      });

      final blocked = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'BLOCKED',
      });

      final userBlocked = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'USER_BLOCKED',
      });

      final unblocked = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'UNBLOCKED',
      });

      final userUnblocked = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'USER_UNBLOCKED',
      });
    ...
    test('fromJson reads unreadCount and unread_count aliases', () {
      final camel = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'UNREAD_COUNT_UPDATED',
        'unreadCount': 9,
      });

      final snake = SocketMessageEventDto.fromJson(<String, dynamic>{
        'type': 'UNREAD_COUNT_UPDATED',
        'unread_count': 10,
      });

      expect(camel.currentUnreadCount, 9);
      expect(snake.currentUnreadCount, 10);
    });
