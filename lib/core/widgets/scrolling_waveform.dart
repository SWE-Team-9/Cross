...
class ScrollingWaveform extends StatefulWidget {
  ...
  static const double _barGap = 1.2;
...
class _ScrollingWaveformState extends State<ScrollingWaveform> {
  ...
  Widget build(BuildContext context) {
    ...
    // Playhead sits at horizontal centre of the screen.
    final double playheadX = screenWidth * 0.5;
    ...
    final double minTranslate = screenWidth - totalWaveWidth - playheadX;
