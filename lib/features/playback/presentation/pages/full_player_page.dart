            ...
            builder: (context, state) {
              ...
              return Stack(
                children: [
                  ...
                  // ── Gradient overlay (bottom-heavy like SoundCloud) ───
                  Positioned.fill(
                    child: Container(
                  ...
                  SafeArea(
                    child: Column(
                      ...
                      children: [
                        // ── TOP: title left, action buttons right ────────
                        Padding(
                          padding: const EdgeInsets.fromLTRB(16, 12, 16, 0),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              // Track title + artist + "Behind this track"
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                        ...
                        // ── Bottom actions (like, repost, share, queue) ──
                        PlayerActions(
