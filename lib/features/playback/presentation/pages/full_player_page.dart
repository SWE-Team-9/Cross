...
import '/core/widgets/scrolling_waveform_clean.dart';
...
class _TrackBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (artworkUrl == null) return Container(color: Colors.black);

    final durationSeconds = (track.durationMs ?? 180000) / 1000.0;
    final maxTranslateX = (durationSeconds / 30.0).clamp(4.0, 12.0);
    final translateX = maxTranslateX * (1.0 - (progress * 2.0));
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                      ...
                      onPressed: () => widget.playerCubit.shuffleCurrentQueue()),
                  RepeatModeButton(
