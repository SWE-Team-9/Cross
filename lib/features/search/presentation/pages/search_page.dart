...
const _kGenres = [
  // بصور
  _Genre.image('Hip Hop & Rap', Color(0xFFFF5500),
      'assets/images/HipHop_&_Rap.png', 502, 443, 'hip-hop'),
  _Genre.image('Electronic', Color(0xFF1A6EDD), 'assets/images/Electronic.png',
      434, 575, 'electronic'),
  _Genre.image(
      'Pop', Color(0xFFDD1A8C), 'assets/images/Pop.png', 431, 579, 'pop'),
  _Genre.image('R&B', Color.fromARGB(255, 87, 44, 104), 'assets/images/R&B.png',
      495, 206, 'r-b-soul'),
  _Genre.image(
      'Rock', Color(0xFFFF5C7A), 'assets/images/Rock.png', 556, 274, 'rock'),
  _Genre.image('Techno', Color(0xFF5C6BC0), 'assets/images/Techno.png', 416,
      600, 'techno'),
  _Genre.image(
      'House', Color(0xFF7B1FA2), 'assets/images/House.png', 416, 600, 'house'),
  _Genre.image('Folk', Color(0xFFFF8A5B), 'assets/images/Folk.png', 501, 729,
      'folk-singer-songwriter'),
  _Genre.image(
      'Indie', Color(0xFF5B8CFF), 'assets/images/Indie.png', 501, 729, 'indie'),
  _Genre.image('Soul', Color(0xFF23B7B3), 'assets/images/Soul.png', 501, 488,
      'r-b-soul'),
  _Genre.image('Country', Color(0xFFFF8A5B), 'assets/images/Country.png', 556,
      274, 'country'),
  _Genre.image(
      'Latin', Color(0xFFD66AC2), 'assets/images/Latin.png', 501, 488, 'latin'),
  _Genre.image(
      'Quran', Color(0xFF16A34A), 'assets/images/Quran.png', 502, 443, 'quran'),
  _Genre.image('Ambient', Color(0xFF2563EB), 'assets/images/Ambient.png', 548,
      264, 'ambient'),
  _Genre.image('Classical', Color(0xFF7C3AED), 'assets/images/Classical.png',
      556, 274, 'classical'),
  _Genre.image(
      'Jazz', Color(0xFFCA8A04), 'assets/images/Jazz.png', 500, 429, 'jazz'),
  _Genre.image(
      'Metal', Color(0xFFEA580C), 'assets/images/Metal.png', 501, 212, 'metal'),
  // بأيقونات
  _Genre.icon(
      'Alternative', Color(0xFF0891B2), Icons.album_outlined, 'alternative'),
  _Genre.icon(
      'Reggaeton', Color(0xFFDB2777), Icons.nightlife_rounded, 'reggaeton'),
  _Genre.icon(
      'Dancehall', Color(0xFFDB2777), Icons.celebration_outlined, 'dancehall'),
  _Genre.icon(
      'Drum & Bass', Color(0xFF7C3AED), Icons.blur_on_rounded, 'drum-bass'),
  _Genre.icon(
      'Deep House', Color(0xFF2563EB), Icons.speaker_rounded, 'deep-house'),
  _Genre.icon('Trance', Color(0xFF7C3AED), Icons.graphic_eq_rounded, 'trance'),
  _Genre.icon('Lo-Fi', Color(0xFF0891B2), Icons.cloud_queue_rounded, 'lo-fi'),
  _Genre.icon('Punk', Color(0xFFEA580C), Icons.electric_bolt_rounded, 'punk'),
  _Genre.icon('Blues', Color(0xFF0891B2), Icons.piano_rounded, 'blues'),
  _Genre.icon(
      'Afrobeat', Color(0xFFCA8A04), Icons.celebration_outlined, 'afrobeat'),
  _Genre.icon('Trap', Color(0xFF7C3AED), Icons.mic_none_rounded, 'trap'),
  _Genre.icon('Experimental', Color(0xFFDB2777), Icons.science_outlined,
      'experimental'),
  _Genre.icon('World', Color(0xFF16A34A), Icons.public_rounded, 'world'),
  _Genre.icon('Gospel', Color(0xFFCA8A04), Icons.church_outlined, 'gospel'),
  _Genre.icon('Spoken Word', Color(0xFF0891B2), Icons.record_voice_over_rounded,
      'spoken-word'),
  _Genre.icon('Sha3by', Color(0xFFEA580C), Icons.queue_music_rounded, 'sha3by'),
  _Genre.icon(
...
class _Genre {
  ...
  const _Genre.icon(this.label, this.color, this.icon, this.queryValue)
      : imagePath = null,
        imageWidth = null,
        imageHeight = null;

  const _Genre.image(this.label, this.color, this.imagePath, this.imageWidth,
      this.imageHeight, this.queryValue)
      : icon = null;
}

String? _toBgImagePath(String? imagePath) {
  if (imagePath == null) return null;
  return imagePath.replaceAll('.png', '_bg.png');
}
// ══════════════════════════════════════════════════════════════════════════════
                ...
                onGenreTap: (genre) => Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => GenrePage(
                      ...
                      genreImagePath: _toBgImagePath(genre.imagePath),
                    ),
                  ),
                ),
              ),
...
class _GenreGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const gap = 2.0;
    final left = [for (int i = 0; i < _kGenres.length; i += 2) _kGenres[i]];
    final right = [for (int i = 1; i < _kGenres.length; i += 2) _kGenres[i]];
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: ClipRRect(
        ...
        child: genre.imagePath != null
            ? AspectRatio(
                aspectRatio: genre.imageWidth! / genre.imageHeight!,
                child: Image.asset(genre.imagePath!, fit: BoxFit.cover),
              )
            : AspectRatio(
                aspectRatio: 2.0,
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    border:
                        Border.all(color: genre.color.withValues(alpha: 0.3)),
                  ),
                  child: Stack(
                    children: [
                      Positioned.fill(
