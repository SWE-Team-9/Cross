...
//         if (state.hasError) return _ErrorView(
...
//                                 Icons.music_note, color: Colors.white38)))
...
//         if (state.hasError) return _ErrorView(
//             onRetry: () => context.read<GenreCubit>().retry());
//         if (state.trending.isEmpty) return const _EmptyState(
...
//         if (state.hasError) return _ErrorView(
//             onRetry: () => context.read<GenreCubit>().retry());
//         if (state.playlists.isEmpty) return const _EmptyState(
...
//           itemBuilder: (_, i) =>
//               _PlaylistCard(playlist: state.playlists[i]),
//         );
//       },
//     );
//   }
...
//         if (state.hasError) return _ErrorView(
//             onRetry: () => context.read<GenreCubit>().retry());
//         if (state.albums.isEmpty) return const _EmptyState(
